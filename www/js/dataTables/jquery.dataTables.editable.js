    ...
    $.fn.makeEditable = function (options) {
        ...
        function fnApplyEditable(aoNodes) {
            ...
            var oDefaultEditableSettings = {
                //event: 'dblclick', //editable on doubleclick
            	event: 'click',
                ...
                "onsubmit": function (settings, original) {
                    ...
                    //new code added
                    //=============================================
                    if(settings.type == "radio" || settings.type == "multicheck" ){
                    	
                    	var input = $("input,select,textarea", this);                    	
                    	                    		
                    	
                    	sNewCellDisplayValue = $(input).val();                    		                    	                    	
                    	$(input).closest("form").val(sNewCellDisplayValue);
...
/*
                                        ...
                                        if (rel >= iColumnCount)
                                            ...
                                            if (this.nodeName.toLowerCase() == "select" || this.tagName.toLowerCase() == "select") {
                                                ...
                                                if (this.type == "checkbox") {
                                                    ...
                                                    if (this.type == "radio" || this.type == "multicheck" ) {
    ...
    function fnUpdateRowOnSuccess(nActionForm) {
        ...
        return this.each(function () {
            ...
            $(".table-action-deletelink").on("click",oTable, _fnOnRowDeleteInline);
                ...
                for (var i = 0; i < properties.aoTableActions.length; i++) {
                    ...
                    if (oActionForm.length != 0) {
                        ...
                        if (oActionFormLink.length != 0) {
                            ...
                            $('body').on("click", oActionFormLink,function () {
