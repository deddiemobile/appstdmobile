...
(function ($) {
    if($.fn.ajaxForm == undefined) {
    	...
    	//$.getScript(("https:" == document.location.protocol ? "https://" : "http://") + "10.13.49.113:7001/appstd/app/js/file/jquery.form.js");
    	$.getScript("/appstd/app/js/file/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>Drag &amp; Drop Αρχεία</b></span>",
            uploadStr:"Επισύναψη",
            abortStr: "Διακοπή",
            cancelStr: "Ακύρωση",
            deletelStr: "Διαγραφή",
            ...
            if($.fn.ajaxForm) {
                ...
                $(obj).append(obj.errorLog);
   				...
   				if(s.showQueueDiv)
        			...
        			obj.container = $(obj).append("<div class='ajax-file-upload-container'></div>");
   				
   				
   				obj.container = $(obj).append("<div class='btn btn-warning' onclick='javascript: $(\".ajax-file-upload-statusbar\").remove()'>Καθαρισμός</div>");
